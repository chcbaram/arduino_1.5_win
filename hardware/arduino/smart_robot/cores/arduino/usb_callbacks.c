...
ONE_DESCRIPTOR String_Descriptor[3] = {
    ...
    {(uint8*)&usbVcomDescriptor_iManufacturer,USB_DESCRIPTOR_STRING_LEN(17)}, 
    {(uint8*)&usbVcomDescriptor_iProduct,     USB_DESCRIPTOR_STRING_LEN(28)}
...
//    printf("->\n");
//    HexDump(&vcomBufferRx[0], newBytes);
